...
import torch
import sys
sys.path.append('/mnt/data/rym/workspace/LLaVA')
...
from ROILLaVA.llava.mm_utils import process_images, tokenizer_image_token, get_model_name_from_path, KeywordsStoppingCriteria
